...
describe('<Pagination />', () => {
  ...
  describe('render()', () => {
    ...
    //   const wrapper = mount(<Pagination {...props} hideDisabled={false} totalItemsCount={1} itemClass={itemClass} />);
    //   const innerUl = wrapper.find('ul');
    //   const firstPage = innerUl.childAt(0);
    //   const prevPage = innerUl.childAt(1);
    ...
    //   const wrapper = mount(<Pagination {...props} hideDisabled={false} totalItemsCount={1} linkClass={linkClass} />);
    //   const innerUl = wrapper.find('ul');
    ...
    //   const wrapper = mount(
    //     <Pagination {...props} hideDisabled={false} totalItemsCount={1} linkClass='link' linkClassFirst='first' />
    //   );
    ...
    //   const wrapper = mount(
    //     <Pagination {...props} hideDisabled={false} totalItemsCount={1} itemClass='item' itemClassFirst='first' />
    //   );
    ...
    //   const wrapper = mount(
    //     <Pagination {...props} hideDisabled={false} totalItemsCount={80} linkClass='link' linkClassPrev='prev' />
    //   );
    ...
    //   const wrapper = mount(
    //     <Pagination {...props} hideDisabled={false} totalItemsCount={80} itemClass='item' itemClassPrev='prev' />
    //   );
    ...
    //   const wrapper = mount(
    //     <Pagination {...props} hideDisabled={false} totalItemsCount={80} linkClass='link' linkClassNext='next' />
    //   );
    ...
    //   const wrapper = mount(
    //     <Pagination {...props} hideDisabled={false} totalItemsCount={80} itemClass='item' itemClassNext='next' />
    //   );
    ...
    //   const wrapper = mount(
    //     <Pagination {...props} hideDisabled={false} totalItemsCount={80} linkClass='link' linkClassLast='last' />
    //   );
    ...
    //   const wrapper = mount(
    //     <Pagination {...props} hideDisabled={false} totalItemsCount={80} itemClass='item' itemClassLast='last' />
    //   );
